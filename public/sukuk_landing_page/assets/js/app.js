$(function () {
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            ...
            $('link[id="style_sheet"]').attr('href', 'sukuk_landing_page/assets/css/skins/default.css');
        }, 1000);
        ...
        if(windowWidth > 992) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', 'sukuk_landing_page/assets/img/logos/black-logo.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', 'sukuk_landing_page/assets/img/logos/logo.png');
                }
            }
        } else {
            $('.logo img').attr('src', 'sukuk_landing_page/assets/img/logos/black-logo.png');
   ...
   $(".dropdown").on('hover', function () {
        ...
        (function (marker) {
            google.maps.event.addListener(marker, "click", function (e) {
                infoWindow.setContent("" +
                    ...
                    "<li><a href='index.html'><i class='fa fa-globe'></i>  http://http://danasyariah.id</li></a> " +
                    "</ul>" +
                    "</div>" +
                    "</div>");
    ...
    $(document).on('click', '.color-plate', function () {
        ...
        $('link[id="style_sheet"]').attr('href', 'sukuk_landing_page/assets/css/skins/' + name + '.css');
    });
