    ...
    <div class="container pt-4"> 
            <div class="col-lg-6 pl-1 pt-5 ">
                <div class="about-text wow fadeInUp delay-04s">
                    <h2><b>@lang('menu.investasi_1')</b></h2>
                    <p style="font-size: 1.2em; line-height: 1.5em; font-weight: 400;" class="pb-3 wow fadeInLeft delay-09s pt-3"> @lang('menu.investasi_1_title')</p>
                        ...
                        <div class="property-thumbnail cover-image" >
                            ...
                            <a href="/proyek/{{$proyek->id}}" class="property-img">
                                ...
                                <div style="font-weight: bold;  margin: 0; float: right;">
                                    ...
                                    @else
                                    <div class="tag button alt featured" style="font-size: 12px; background-color: #1F5865;"><i class="fas fa-stopwatch"></i> Sisa {{ Carbon\Carbon::now()->parse($proyek->tgl_selesai_penggalangan)->diffInDays()+2}} Hari Lagi</div>
                                    @endif
                                </div>
                                    ...
                                    <div class="col-lg-6 text-left pr-2">
                                        <div class="ratings text-secondary">
                                            ...
                                            <span class="p-text-bold"> 
                                                Rp {{number_format((($proyek->total_need*($proyek->profit_margin/100))),0, '', '.')}} ({{$proyek->profit_margin}}%)       
                                            </span>                                
                                        </div>
                                    </div>
                                    <div class="col-6 text-left">
