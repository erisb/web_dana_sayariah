        ...
        <div class="col-md-12">
            ...
            <div class="card" id="view_card_table">
                <div class="card-header">
                    <strong class="card-title">Data FAQ</strong>
                </div>
                <div class="card-body">
                ...
                <button class="btn btn-success" data-toggle="modal" data-target="#tambah">Tambah FAQ</button><br/><br/>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="card-body card-block">
                        <div class="form-row">
                            <div class="col-sm-9 col-lg-10 ml-3 ml-sm-0">
                                ...
                                <textarea class="col-sm-12 form-control" name="deskripsi" placeholder="Deskripsi" required="required" cols="30" rows="10"></textarea>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" disabled>Tambah Term & Condition</button>
    ...
    <!--script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#table_threshold tbody').on( 'click', '#ganti_threshold', function () {
                ...
                for(i=1;i<=2;i++)
                {
                    option += '<option value="'+i+'" '+(i == tipe ? "selected" : "")+'>'+(i == 1 ? 'Investor' : 'Borrower')+'</option>';
                }
