		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a id="tarik_dana_investor" class="btn btn-primary">Tarik Dana Pendana</a>
    ...
    <script>
		...
		$(document).ready(function(){
			...
			table = $('#tbl_list').DataTable({
				...
				ajax : {
					type : "get",
					url : '/admin/list_tarik_dana_investor/'
				...
				"columnDefs": [{
					...
					class : 'text-center',
					"render" : function(data, type, value, meta){
						return '<button class="btn btn-info" data-toggle="modal" data-target="#modal_detail_tarik" onclick="detail_tarik('+value["Detil Tarik Dana"]+')">List Tarik Dana</button>';
						//return row[6];
					}
				},
				]
		...
		function detail_tarik(id){
			...
			$('#modal_detail_tarik').on('show.bs.modal', function(e) {
				...
				$("#tarik_dana_investor").attr('href', '/admin/tarik_dana/'+id+'');
				var table_detail_tarik = $("#tbl_detail_tarik").DataTable();
