...
@endif
    ...
    <div class="card" id="view_card_table">
        <div class="card-header">
            <strong class="card-title">Data Khazanah</strong>
        </div>
        <div class="card-body">
        <button class="btn btn-success" data-toggle="modal" data-target="#tambah" style="margin-left: 15px;">Tambah Khazanah</button>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.addKhazanah')}}" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" id="ganti" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.updateKhazanah')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                <div class="col-lg-12">
                    <div class="card-body card-block">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var gambarTable = $('#table_carousel').DataTable({
                ...
                // serverSide: true,
                ajax: {
                    url: '/admin/data_khazanah_datatables/',
                    dataSrc: 'data'
                },
                paging: true,
                info: true,
                ...
                columns: [
                    ...
                    { data: null,
                        render:function(data,type,row,meta){
                            ...
                            return '<button class="btn btn-info btn-sm active" data-toggle="modal" data-target="#ganti" id="ganti_gambar">Perbaharui</button><br><br><button class="btn btn-warning btn-sm active" data-toggle="modal" data-target="#change_password" id="hapus_gambar">Hapus</button>';
                        }
                    }
                ],
                columnDefs: [
