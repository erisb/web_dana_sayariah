						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Pilih menu untuk diubah:</label>
									...
									<span class="add-new-menu-action"> or <a href="{{ $currentUrl }}?action=edit&menu=0">Tambah Menu</a>. </span>
								</form>
							</div>
												...
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														...
														<div class="publishing-action">
															<a onclick="createnewmenu()" name="save_menu" id="save_menu_header" class="button button-primary menu-save">Tambah menu</a>
														</div>
														@elseif(request()->has("menu"))
														<div class="publishing-action">
															<a onclick="getmenus()" name="save_menu" id="save_menu_header" class="button button-primary menu-save">Simpan menu</a>
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																<i>Place each item in the order you prefer. Click on the arrow to the right of the item to display more configuration options.</i>
															</p>
														</div>
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																Silahkan masukan nama dan pilih Tombol "Tambah menu"
															</p>
														</div>
														@endif
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="field-css-classes description description-thin">
																		<label for="edit-menu-item-classes-{{$m->id}}"> Class CSS (opsional)
																			<br>
																	...
																	<p class="field-css-role description description-wide">
																		<label for="edit-menu-item-role-{{$m->id}}"> Peran
																			<br>
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<a class="item-delete submitdelete deletion" id="delete-{{$m->id}}" href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Hapus</a>
																		<span class="meta-sep hide-if-no-js"> | </span>
																		<a class="item-cancel submitcancel hide-if-no-js button-secondary" id="cancel-{{$m->id}}" href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Gagal</a>
																		<span class="meta-sep hide-if-no-js"> | </span>
																		<a onclick="updateitem({{$m->id}})" class="button button-primary updatemenu" id="update-{{$m->id}}" href="javascript:void(0)">Perbaharui item</a>
