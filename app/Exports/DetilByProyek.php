...
class DetilByProyek implements FromArray, ShouldAutoSize, WithHeadings
{
    /**
    ...
    */
    ...
    public function array(): array
    {
        ...
        // var_dump($this->data_arr);die;
        if($id != null){

            $data = Proyek::where('proyek.id',$id)
                            ->leftJoin('pendanaan_aktif','pendanaan_aktif.proyek_id','=','proyek.id')
